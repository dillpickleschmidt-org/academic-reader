  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] gap-4 items-center">
      ...
      <div className="bg-muted/40 rounded-xl p-4 border border-border/50">
        <div className="text-[7px] uppercase tracking-widest text-muted-foreground/50 font-mono mb-3">
          Original PDF
        </div>
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            ...
            <div
              className="h-1.5 bg-muted-foreground/10 rounded w-11/12"
      ...
      <div className="bg-background rounded-xl p-4 border border-primary/15 shadow-sm">
        <div className="text-[7px] uppercase tracking-widest text-primary/50 font-mono mb-3">
          Converted
        </div>
        <div className="space-y-2">
